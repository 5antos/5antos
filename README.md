...
The main projects that I've been working on are [PT.FM](https://top.gg/bot/767504539087273985), a portuguese Discord radio bot supporting over 30,000 different radio stations and podcasts and [Simpl.DB](https://simpldb.js.org/), a lightweight, 0 dependency, easy-to-use local database using JSON to store data, using Node.js.
